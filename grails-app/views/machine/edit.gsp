...
<%@ page import="com.drawingboard.Machine" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="queues"><g:message code="machine.queues.label" default="Queues" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: machineInstance, field: 'queues', 'errors')}">
                                    
<ul>
<g:each in="${machineInstance?.queues?}" var="q">
    <li><g:link controller="queue" action="show" id="${q.id}">${q?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="queue" action="create" params="['machine.id': machineInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'queue.label', default: 'Queue')])}</g:link>
